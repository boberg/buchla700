...
#define	TOP_EDGE	1		/* top edge of configuration box */
#define	RGT_EDGE	128		/* right edge of configuration box */
#define	BOT_EDGE	128		/* bottom edge of configuration box */

int LftEdge = LFT_EDGE;
int TopEdge = TOP_EDGE;
int RgtEdge = RGT_EDGE;
int BotEdge = BOT_EDGE;
